  ...
  return (
    <section className="bg-white pt-10 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="space-y-6 sm:hidden">
          {[
            ...
            },
            {
              tarea: "Recordatorios",
              sin: "Se olvidan",
              con: "Automáticos por WhatsApp"
            },
            {
              tarea: "Reputación online",
              sin: "Difícil de controlar",
              con: "Solicita reseñas automáticamente"
            },
            {
              tarea: "Costo mensual",
              sin: "$6,100+ en personal",
              con: "Desde $1,899 MXN"
            },
          ].map((item, index) => (
            <div key={index} className="border border-gray-200 rounded-xl p-4 text-left">
              <h4 className="font-bold text-gray-800 mb-2">{item.tarea}</h4>
              <p className="mb-1 text-red-600 flex items-center gap-2">
                <XCircle size={16} /> <span>Sin Senda: {item.sin}</span>
              </p>
              <p className="text-green-600 flex items-center gap-2">
                <CheckCircle size={16} /> <span>Con Senda: {item.con}</span>
              </p>
            </div>
          ))}
        </div>
        ...
        {/* Desktop Table */}
        <div className="hidden sm:block overflow-x-auto mb-16">
